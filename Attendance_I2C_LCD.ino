...
#define eraseMaster 8 //Push-button connected to pull-up resistance on A4.
#define eraseALL  7 //Push-button connected to pull-up resistance on A5.
...
void loop() {
  ...
  */
  switch (Mode) {
  /*   Admin Mode   */ case 0: do {
        ProgramMode();
      } while (AdminFlag == 4); break; // To exit ProgramMode when only Master is swiped.
